...
userRoutes.get("/by-class-result", authenticateToken, admin, users.getStudentsByClassResult);
userRoutes.put("/update_personal/:id", authenticateToken, users.update_user);
...
userRoutes.put("/update-class-status/:id", authenticateToken, admin, users.updateClassStatus);
userRoutes.post("/promote-students", authenticateToken, admin, users.promoteStudents);